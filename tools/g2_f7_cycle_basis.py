...
out = {
    ...
    "basis_cycle_lengths": [b["cycle_length"] for b in basis],
    "basis_cycles": basis,
    "note": "Fundamental cycle basis extracted from exact F7 graph."
}

Path("docs/data/f7_cycle_basis.json").write_text(json.dumps(out, indent=2))
print("wrote docs/data/f7_cycle_basis.json")
