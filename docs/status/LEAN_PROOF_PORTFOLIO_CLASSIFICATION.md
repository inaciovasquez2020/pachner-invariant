...
Proof-facing Lean artifact. Strongest formal surface. Full theorem claims remain bounded by in-repository proved statements.
...
`pachner-invariant` is a proof-facing Lean artifact subject to its explicit in-repository boundaries.
